...
home page leading into three sections (Tech Blogs, Code, Book Reviews), each
...
- **`googlec3f78c67c001ce01.html` at the repo root is a Google Search
  Console ownership-verification file** (HTML-file method) — it's not
  generated by the build and isn't dead code, don't delete it during
  cleanup. It must stay at the domain root (`https://ctkhanhly.github.io/googlec3f78c67c001ce01.html`),
  not under `assets/` or any subpath, or verification breaks.
